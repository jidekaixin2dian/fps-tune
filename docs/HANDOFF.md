...
**完整待办总表见 `docs/dev/PLAN-backlog.md`（P0–P2）。** P0、P1 与 **P2-6 均已收口**，摘要：

1. **P2-8** 按厂商生成驱动内手动设置清单（A 卡 / Intel）—— **覆盖面最大**（非 N 卡用户目前无指引）。
2. **P2-11** 备份页展示 `.restored` 消费记录 —— 小改动、体验直接。
3. **P2-10 / P2-12** ICC 自选 `.icc` / `.icm`、A/B 页 PresentMon 前置检测。
4. **P2-2 / P2-4** 依赖真实 A/B 数据，而 P0-2 已被用户取消 → **无前置数据，暂缓**。
