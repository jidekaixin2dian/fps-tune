...
2. 更新 `docs/HANDOFF.md` 的"当前状态"和"下一步"——这是下一个代理唯一的入口。
3. 提交 → 按用户授权决定是否推送 `beta`。
4. 若改了版本线、发布产物或公开口径，同步检查 `README.md` / `README.en.md` / `RELEASE.md` 是否跟着过期。
